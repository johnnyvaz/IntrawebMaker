...
(function (MakerJsPlayground) {
                ...
                switch (attrs.type) {
                    ...
                    case 'font':
                        ...
                        for (var fontId in fonts) {
                            ...
                            if (!FontLoader.fontMatches(font, attrs.value))
                                continue;
                            if (!added) {
    ...
    function constructOnMainThread(successCb) {
        var fontLoader = new FontLoader(MakerJsPlayground.fontDir, opentype, processed.kit.metaParameters, processed.paramValues);
    ...
    window.onhashchange = function () {
        ...
        if (document.location.hash && document.location.hash.length > 1) {
            ...
            var fontLoader = new FontLoader(MakerJsPlayground.fontDir, null, processed.kit.metaParameters, makerjs.kit.getParameterValues(processed.kit));
